...
Anxiety and destructive behavior in high-drive dogs are symptoms, not diagnoses. And the underlying condition, in most cases, is simple: the dog has more energy than it has outlets, and that surplus finds its own exit.
