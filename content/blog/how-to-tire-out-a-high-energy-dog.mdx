...
There is no universal number. But a useful frame: if your dog is still showing aroused, reactive, or destructive behavior after the exercise you are currently providing, the current protocol is not sufficient. Our guide on [how much exercise your dog needs](/blog/how-much-exercise-does-my-dog-need/) breaks down the ranges by drive level. For a personalized target based on your dog's specific drive, age, and health, the [exercise calculator](/tools/dog-exercise-calculator/) builds one in about two minutes.
