...
export const SERVICE_CITY_PAGES: ServiceCityPage[] = [
  {
    ...
    paragraphs: [
      ...
      "Standard pricing is live in Destin — Intro Session, Private Conditioning Session, and Session Packages are all bookable now — but the Founding Athlete cohort is still the best rate while it lasts: five sessions for $200, capped at 20 dogs, one-time, with no lifetime rate lock. Whether you are wintering here or a year-round local, book online and we confirm your address on the day's route. Questions before you commit? Call or text 850-218-5855 — Travis responds personally.",
    ],
    crossLinks: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Standard rates are live now — Intro, Private Conditioning, and Session Packages all bookable — alongside the Founding Athlete offer: five sessions for $200, a one-time introductory rate capped at 20 dogs, no lifetime lock. See how sessions are structured on our services page, then pick a time online. Your dog's conditioning should not wait on PCS orders or a free Saturday that never comes.",
    ],
  },
  {
    slug: 'niceville',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Full walk-up pricing is live now. The Founding Athlete deal — $200 for five sessions, capped at 20 dogs — is a one-time rate while it lasts, with no lifetime lock. Book online and we confirm your Shalimar address on the day's route, or call 850-218-5855 with questions before you schedule.",
    ],
  },
  {
    slug: 'mary-esther',
    ...
    paragraphs: [
      ...
      "Standard rates are live now. The Founding Athlete bundle still runs five sessions for $200 while the 20-dog cap holds — a one-time rate, not a lifetime lock. Book online and we confirm your Mary Esther address on the route, or call 850-218-5855 before you commit.",
    ],
  },
  {
    slug: 'navarre',
    ...
    paragraphs: [
      ...
      "Walk-up rates are live now. The Founding Athlete offer — $200 for five sessions, limited to 20 dogs, one-time with no lifetime lock — is still open while spots remain. Book online and we confirm your Navarre address fits the day's route, or call 850-218-5855 with neighborhood questions.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Walk-up pricing is live now, alongside the Founding Athlete offer — $200 for five sessions, limited to 20 dogs, one-time with no lifetime lock. Book online and we confirm your Santa Rosa Beach address on the route — HOA access and parking rules covered in that same conversation. Questions first? Call 850-218-5855.",
    ],
  },
  {
    slug: 'bluewater-bay',
    ...
    paragraphs: [
      ...
      "Standard rates are live now. The Founding Athlete run holds at five sessions for $200 while the 20-dog cap remains — one-time, no lifetime lock. Book online and we confirm your Bluewater Bay address fits the day's map, or call 850-218-5855 with questions.",
    ],
  },
  {
    slug: 'valparaiso',
    ...
    paragraphs: [
      ...
      "Walk-up rates are live now. The Founding Athlete offer — $200 for five sessions, limited to 20 dogs — is still a one-time rate while spots remain, with no lifetime lock. Book online and we confirm your Valparaiso address on the route, or call 850-218-5855 — Travis responds personally.",
    ],
  },
];
