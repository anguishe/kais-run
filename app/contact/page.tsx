    ...
    <>
      ...
      <main className="min-h-screen bg-brand-black pb-8 pt-28 md:pt-32">
        <div className="mx-auto max-w-4xl px-6">
          <p className="font-body text-xs uppercase tracking-[0.28em] text-brand-teal-light">Get in touch</p>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2">
            <div className="rounded-xl border border-brand-teal/20 bg-brand-charcoal/40 p-6">
              ...
              <ul className="mt-4 space-y-3 font-body text-sm text-brand-gray">
                <li>
                  ...
                  <a href="tel:+18502185855" className="text-brand-teal-light hover:underline">850-218-5855</a>
                </li>
                <li>
                  <span className="text-brand-offwhite/90">Email:</span>{' '}
                  <a href="mailto:kaisrunmobile@gmail.com" className="text-brand-teal-light hover:underline">
              ...
              <ul className="mt-4 space-y-3 font-body text-sm text-brand-gray">
                <li>
                  <a href="https://www.instagram.com/kaisrun" className="text-brand-teal-light hover:underline" rel="noopener">Instagram</a>{' '}·{' '}
                  <a href="https://www.tiktok.com/@kaisrun" className="text-brand-teal-light hover:underline" rel="noopener">TikTok</a>{' '}·{' '}
                  <a href="https://www.facebook.com/kaisrun" className="text-brand-teal-light hover:underline" rel="noopener">Facebook</a>
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-xl border border-brand-teal/20 bg-brand-charcoal/40 p-6">
              ...
              <p className="mt-4 font-body text-sm leading-relaxed text-brand-gray">
                ...
                Valparaiso, FL.{' '}
                <Link href="/service-area/" className="text-brand-teal-light hover:underline">See your city →</Link>
              </p>
          ...
          <p className="mt-12 max-w-2xl font-body text-base leading-relaxed text-brand-gray">
            Kai&apos;s Run is a mobile canine conditioning service based in Destin, covering eleven
            cities across the Emerald Coast from Navarre to Miramar Beach. Every session happens at
            your home - we bring the slatmill, the harness, and the cameras to your driveway. If you
            are not sure whether your dog or your address is a fit, the fastest answer is a call or a
            text.
          </p>
        </div>
