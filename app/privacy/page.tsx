    ...
    <main className="min-h-screen bg-[#0F1117] py-16 px-6">
      ...
      <div
          ...
          dangerouslySetInnerHTML={{
            __html: `<span data-custom-class="subtitle">Last updated: July 8, 2026</span><br><br>
...
<span data-custom-class="body_text">We may share information with service providers who assist us. Our website contact, waitlist, founding, and lead magnet forms are delivered through Formspree, Inc., which processes submissions on our behalf. If you join our email list or receive marketing updates, your contact information may be stored and sent through Mailchimp (or a comparable ESP we configure) so we can honor unsubscribe requests and measure engagement. We do not sell your personal information for monetary consideration, and we do not allow these vendors to use your information for their own independent advertising except as described in their respective policies.</span><br><br>
...
<span data-custom-class="body_text">Every conditioning session is recorded on a multi-camera rig from start to finish. This is a deliberate practice - it documents how your dog is handled, protects both of us, and gives you footage of your dog&apos;s work. The cameras capture video and audio. You consent to this recording in the waiver signed before your dog&apos;s first session, and Florida law requires that consent for audio.</span><br><br>
<span data-custom-class="body_text">Footage is delivered directly to you via a private link. We retain our copy for 90 days after the session, then delete it. We may use footage and photos of your dog for marketing - on our website and social media - unless you opt out, which you can do on the waiver or at any time by emailing kaisrunmobile@gmail.com. We do not publish your full name or street address in marketing without your separate written permission. To request earlier deletion of your footage, email kaisrunmobile@gmail.com.</span><br><br>
<span data-custom-class="body_text">For the full picture of what we record and why, see the <a href="/how-we-record/" data-custom-class="link">how we record</a> page.</span><br><br>
