...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.kaisrun.xyz/privacy/' },
};
...
<span data-custom-class="body_text">This site uses Google AdSense, a third-party advertising service provided by Google, to display ads on our blog. Google and its partners use cookies and similar technologies to serve ads based on your prior visits to this and other websites.</span><br><br>
...
<span data-custom-class="body_text">We do not control the cookies or data collected by Google or its advertising partners. Ads appear on our blog content only. Our booking, pricing, and service pages do not serve ads.</span><br><br>
